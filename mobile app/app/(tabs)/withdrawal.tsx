...
const styles = StyleSheet.create({
  ...
  title: { color: '#17233f', fontSize: 24, fontWeight: '800' },
  subtitle: { color: '#82909e', fontSize: 13, marginTop: 3 },
  addButton: { backgroundColor: '#2f5bff', width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  ...
  modalTitle: { color: '#17233f', fontSize: 20, fontWeight: '800' },
  label: { color: '#3a4a5a', fontSize: 13, fontWeight: '600', marginBottom: 8, marginLeft: 4 },
  input: { backgroundColor: '#f5f7ff', borderWidth: 1, borderColor: '#dbe2f3', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, color: '#17233f', marginBottom: 14 },
  balanceInfo: { color: '#2f5bff', fontSize: 13, fontWeight: '600', marginBottom: 12 },
  ...
  submit: { backgroundColor: '#2f5bff', borderRadius: 16, paddingVertical: 16, alignItems: 'center' },
